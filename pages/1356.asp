...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"
...
<div id="maincontenttext">"Education for responsible global citizenship - EU contribution towards the UN Decade on Education for Sustainable Development" An EU Presidency Conference <BR><BR>For further information please contact Günther Pfaffenwimmer <A href="mailto:guenther.pfaffenwimmer@bmbwk.gv.at ">guenther.pfaffenwimmer@bmbwk.gv.at <BR></A></div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->

<div id="colRight">
<a href="http://www.unece.org/env/esd/HLM.intervent/Austria.Intervention.doc " target="_blank">Læs mere </A><BR><BR>
</div><!-- colRight -->
