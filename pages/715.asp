...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Internationale konferencer"%></title><!--#include virtual="/includes/head.asp" -->
...
<!-- MAIN CONTENT -->
<div id="maincontent">
<h2>Internationale konferencer</h2>
<div id="maincontenttext">I forbindelse med FN-tiåret afholdes der konferencer både herhjemme og internationalt. Her på siden kan du finde nogen af de internationale konferencer, der indtil nu har været afholdt.</div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->
