...
<div id="maincontent">
<h2>Nyhedsmail</h2>
<div id="maincontenttext">For at tilmelde dig Øko-nets nyhedsmail om blandt andet Uddannelse for Bæredygtig Udvikling skal du blot sende din email-adresse til <A href="mailto:eco-net@eco-net.dk">eco-net@eco-net.dk</A> og mærke den "UBU-nyhedsmail". Skriv også gerne din adresse og dit telefonnummer og lidt om dine egne projekter. <BR></div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->
