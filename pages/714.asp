...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Danske konferencer"%></title><!--#include virtual="/includes/head.asp" -->
...
<!-- MAIN CONTENT -->
<div id="maincontent">
<h2>Danske konferencer</h2>
<div id="maincontenttext"><P>I forbindelse med FN-tiåret afholdes der konferencer både herhjemme og internationalt. Her på siden kan du finde de danske konferencer, der indtil nu har været afholdt.</P></div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->
