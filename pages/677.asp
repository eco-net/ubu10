...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Pressemeddelelser"%></title><!--#include virtual="/includes/head.asp" -->
...
<div id="maincontenttext">Du finder her de pressemeddelelser, der er udsendt i forbindelse med Øko-nets aktiviteter i tiåret. </div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->
